        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            <li class="nav-small-cap">
              ...
              <span class="hide-menu">Statistik Mahasiswa</span>
            </li>
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">Statistik Nilai</span>
            </li>
            <li class="sidebar-item">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Design and Developed by <a href="https://baa.ums.ac.id/" target="_blank" class="pe-1 text-primary text-decoration-underline">BAA UMS</a></p>
        </div>
      </div>
    </div>
  </div>
